...
class Preview(db.Model):
    ...
    create_at = db.Column(db.DateTime, default=get_time(), comment='创建时间')
    update_at = db.Column(db.DateTime, default=get_time(), onupdate=get_time(), comment='创建时间')
